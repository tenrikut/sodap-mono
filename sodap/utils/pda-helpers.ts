...
export const PROGRAM_ID = new PublicKey('4eLJ3QGiNrPN6UUr2fNxq6tUZqFdBMVpXkL2MhsKNriv');
 ...
 */
export function findReceiptPDA(storePubkey: PublicKey, buyerPubkey: PublicKey): PublicKey {
  const [pda] = PublicKey.findProgramAddressSync(
 ...
 */
export function findProductPDA(storePubkey: PublicKey, productUuid: string): PublicKey {
