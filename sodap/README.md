...
[![Next.js](https://img.shields.io/badge/Next.js-v15.3-black)](https://nextjs.org/)
...
git clone https://github.com/yourusername/sodap-app.git
cd sodap-app
...
# Set up Solana development environment (if developing)
solana-keygen new --outfile ~/.config/solana/id.json
solana config set --url devnet

# Build and deploy the Solana program (if developing)
anchor build
anchor deploy
...
NEXT_PUBLIC_SODAP_PROGRAM_ID=4eLJ3QGiNrPN6UUr2fNxq6tUZqFdBMVpXkL2MhsKNriv
